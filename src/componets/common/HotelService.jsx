          ...
          <Col>
            <Card>
              <Card.Body>
                ...
                <Card.Text>Stay refreshed with our in-room mini-bar.</Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col>
            <Card>
              <Card.Body>
                ...
                <Card.Text>Enjoy convenient on-site parking during your stay.</Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col>
            <Card>
              <Card.Body>
                ...
                <Card.Text>Stay cool and comfortable with our air conditioning.</Card.Text>
              </Card.Body>
            </Card>
          </Col>
        </Row>
